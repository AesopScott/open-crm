...
const BUILTIN_COLUMNS: Record<EntityType, ReadonlySet<string>> = {
  ...
  contact: new Set(["id", "first_name", "pipeline", "last_name", "email", "phone", "company_id", "title", "status", "registration_code", "event_slug", "event_name", "event_date", "created_at", "updated_at"]),
